  ...
  const buildPreset: Record<BuildFlags['channel'], BUILD_CONFIG_TYPE> = {
    get stable() {
      return {
        ...
        changelogUrl: BRAND.urls.changelog,
        downloadUrl: BRAND.urls.download,
        pricingUrl: BRAND.urls.pricing,
        discordUrl: BRAND.urls.discord,
        requestLicenseUrl: BRAND.urls.requestLicense,
