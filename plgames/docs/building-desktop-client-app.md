# Building PLGames Desktop Client App
...
```shell
BUILD_TYPE=canary corepack yarn plgames @affine/electron build

BUILD_TYPE=canary corepack yarn plgames @affine/electron generate-assets
```
...
```shell
BUILD_TYPE=canary SKIP_WEB_BUILD=1 HOIST_NODE_MODULES=1 corepack yarn plgames @affine/electron make
```
...
corepack yarn plgames @affine/electron package
corepack yarn plgames @affine/electron make-squirrel
corepack yarn plgames @affine/electron make-nsis
```
