...
import { StarBrandModal } from './star-brand-modal';
...
const SettingModalInner = ({
  ...
  const [openStarBrandModal, setOpenStarBrandModal] = useState(false);

  const handleOpenIssueFeedbackModal = useCallback(() => {
    setOpenIssueFeedbackModal(true);
  }, [setOpenIssueFeedbackModal]);

  const handleOpenStarBrandModal = useCallback(() => {
    setOpenStarBrandModal(true);
  }, [setOpenStarBrandModal]);
        ...
        <Scrollable.Root>
          ...
          >
            <div className={style.centerContainer}>
                  ...
                  components={{
                    1: (
                      <span
                        ...
                        onClick={handleOpenStarBrandModal}
                      />
                    ),
                    2: (
                      <span
              ...
              <StarBrandModal
                open={openStarBrandModal}
                setOpen={setOpenStarBrandModal}
              />
              <IssueFeedbackModal
