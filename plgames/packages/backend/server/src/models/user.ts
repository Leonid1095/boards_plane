...
import type { ConnectedAccount, Prisma as PrismaNamespace, User } from '@prisma/client';
...
type CreateUserInput = Omit<PrismaNamespace.UserCreateInput, 'name'> & { name?: string };
type UpdateUserInput = Omit<Partial<PrismaNamespace.UserCreateInput>, 'id'>;

type CreateConnectedAccountInput = Omit<
  PrismaNamespace.ConnectedAccountUncheckedCreateInput,
  'id'
> & { accessToken: string };
type UpdateConnectedAccountInput = Omit<
  PrismaNamespace.ConnectedAccountUncheckedUpdateInput,
  'id'
>;
