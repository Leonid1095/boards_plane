...
export class LicenseService {
  ...
  async deactivateTeamLicense(license: InstalledLicenseType) {
  ...
  private async revalidateRecurringLicense(license: InstalledLicenseType) {
    try {
  ...
  private revalidateOnetimeLicense(license: InstalledLicenseType) {
